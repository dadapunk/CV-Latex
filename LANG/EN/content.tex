\cvsection{Experience}
    \begin{cvtable}
        \cvitem{11, 2020 -- 01, 2021}{\color{cvsectioncolor}Consultant}{\textbf{ILO Consultor, CL}}{I developed an automated web scraping solution in Python B4s to capture data from public job portals, which allowed the company to obtain valuable information about the labour market.}
        \cvitem{07, 2019 -- 01, 2020}{\color{cvsectioncolor}SAPUI5 -IoT Consultant}{\textbf{SCLOUD, CL}}{I designed and developed IoT prototypes, a customized dashboard for a client in the wine industry using technologies such as ESP32 and SAPUI5, which improved the efficiency of their production process and enabled them to make informed decisions in real time.}
...
\aboutme{Responsible, analytical and methodical IT professional with experience in projects involving different languages
...
I am passionate about the creation and exploration of technological tools that streamline and facilitate processes, improve the quality of life and contribute to a better understanding of our reality.}
