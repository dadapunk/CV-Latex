\cvsection{Experience}
    \begin{cvtable}
        \cvitem{07, 2023 -- Currently}{\color{cvsectioncolor}Developer/SysAdmin}{\textbf{Irepartners, ES}}{I maintained, improved, and developed software tools and solutions that enhanced the productivity of the development team and supported the company's operational objectives.}
...
\begin{cvtable}
    \cvitemmedium{01, 2025}{\href{}{\color{cvsectioncolor}\small Azure AZ-400: Microsoft DevOps Certification (In progress) }}{\textbf{Microsoft}}
