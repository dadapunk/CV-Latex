...
\begin{cvtable}
    \cvitem{11, 2020 -- 01, 2021}{\color{cvsectioncolor}Consultor Desarrollador}{\textbf{ILO Consultor, CL}}{Desarrollé una solución de web scraping automatizada en Python B4s para capturar datos de portales públicos de empleo, lo que permitió a la empresa obtener información valiosa sobre el mercado laboral.}
